<x-layout>
    <button class="ml-5 w-10 h-10 bg-white mt-5 rounded">
        <a href={{route("home")}}>{{__("language.back")}}</a>
    </button>
    <div class="flex-col mx-auto">
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-white">{{__("language.log in")}}</h2>
            </div>
            ...
            @csrf
          <div>
            <label for="email" class="block text-sm font-medium text-gray-700">{{__("language.email adress")}}</label>
            <div class="mt-1">
